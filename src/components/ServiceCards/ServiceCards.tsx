  ...
  return (
    <>
      <div id="Service" className="w-full px-4 md:px-9 lg:px-14 gap-4 space-y-4 md:space-y-6 lg:space-y-0 flex flex-col md:flex-row flex-wrap items-center justify-center py-6 bg-[#0D0D0D] text-[#C9C9C9] bg-[url('/images/service-bg.png')] bg-no-repeat bg-right bg-auto">
        <div className="w-full md:w-[45%] lg:w-[32%] border rounded-xl px-4 py-2 h-auto">
          <Image src={"/images/brand.png"} alt="" width={100} height={20} className="w-40"/>
          <h3 className="font-bold text-xl leading-7">Brand Strategy & Identity</h3>
        </div>
        <div className="w-full md:w-[45%] lg:w-[32%] border rounded-xl px-3 py-2 h-auto">
          <Image src={"/images/social-media.png"} alt="" width={100} height={20} className="w-40"/>
          <h3 className="font-medium text-xl leading-7">Social Media Growth & Management</h3>
        </div>
        <div className="w-full md:w-[45%] lg:w-[32%] py-2 h-auto">
       ...
       <div className="w-full md:w-[45%] lg:w-[32%] border rounded-xl px-3 py-2 h-auto">
        <Image src={"/images/creative-design.png"} alt="" width={100} height={20} className="w-40"/>
          <h3 className="font-medium text-xl leading-7">Creative Design & Visuals</h3>
        </div>
        <div className="w-full md:w-[45%] lg:w-[32%] border rounded-xl px-3 py-2 h-auto">
          <Image src={"/images/paid-media.png"} alt="" width={100} height={20} className="w-40"/>
          <h3 className="font-medium text-xl leading-7">Paid Marketing & Lead Generation</h3>
        </div>
        <div className="w-full md:w-[45%] lg:w-[32%] border rounded-xl px-3 py-2 h-auto">
          <Image src={"/images/web.png"} alt="" width={100} height={20} className="w-40"/>
